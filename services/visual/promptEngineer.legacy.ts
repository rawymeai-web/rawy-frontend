...
- No split screen line ΓÇö continuous art.`;
            }
...
**REFERENCE INPUTS:**
- **Character Photo (NDA Image):** This is the **sole source of truth** for the childΓÇÖs identity.
- **Style:** ${visualDNA}

**STRICT CHARACTER LOCK:**
- Render the child with exact facial topology and hair pattern from the reference photo.
- The face must match reference DNA image ΓÇö no stylization of facial proportions.
...
- Character must be integrated into the environment ΓÇö not pasted or floating.
